...
**File locations:** All Ralph workflow files (prd.json, progress.txt, fix_plan.md, CODEBASE-MAP.md, specs/) are in the same directory as this PROMPT.md file. The files were passed to you as context - use those exact file paths when reading.
